...
public class AvgResponsePerMin implements Job {
...
//public static void main(String[] args) {
	...
	public void execute(JobExecutionContext context)
		...
		try {
			...
			DBCollection andavgpermin = db.getCollection("AndroidAvgPerMin");
	...
	private static void checkAlertStatus() {
		...
		{*/
			...
			int alertthreshold = (Integer) txnDataObject
			...
			if (AvgOfRegular > alertthreshold) {
				...
				System.out.println("AvgResponsePerMin , mail not sent, avg is below Threshold");
			}
		}
//	}

	public static void setMail() {
		userMail1 = cisDb.getCollection("first").findOne();
		email = userMail1.get("Email").toString();
		System.out.println("Email :" + email);
	}
	public static void main(String[] args) throws JobExecutionException {
		new AvgResponsePerMin().execute(null);
	}
}