...
$(document).ready(function() {
	$("#0").click(function() {
		...
		$("#LINKS").load("PremiumgraphsIOS/link1.jsp");
	});

		$("#1").click(function() {
			$("#LINKS").empty();
			$('.cssload-container').show();
			$("#LINKS").load("PremiumgraphsIOS/link2.jsp");
		});
		$("#2").click(function() {
			$("#LINKS").empty();
			$('.cssload-container').show();
			$("#LINKS").load("PremiumgraphsIOS/link3.jsp");
		});

		$("#3").click(function() {
			$("#LINKS").empty();
			$('.cssload-container').show();
			$("#LINKS").load("PremiumgraphsIOS/link4.jsp");
		});

		$("#4").click(function() {
			$("#LINKS").empty();
			$('.cssload-container').show();
			$("#LINKS").load("PremiumgraphsIOS/link5.jsp");
		});
...
<body onload="showDiv()">
 ...
 %>
			...
			<p>
				<font size="2">OS Version - <%=andrver%></font>
			</p>
			<p>
		...
		<div id="LINKS" style="padding-top: 2%">
			<%@include file="PremiumgraphsIOS/link1.jsp"%>
		</div>
