...
DBCollection link3_colls = link3_dbs.getCollection("IOSData");
...
for(int i = link3_list.size()-1;i >= 0 ; i--)
{
	...
	link3_temp_ram=(Double)obj2.get("ram");
...
int link3_battery_life = 0;

while(cursor3.hasNext()){
	DBObject obj1 = cursor3.next();
	link3_total += (Integer)obj1.get("duration");
	link3_battery_life += (Integer)obj1.get("battery_life");
}
