...
DBCollection link5_colls = link5_dbs.getCollection("IOSData");
...
for(int i = link5_list.size()-1;i >= 0 ; i--)
{
	...
	link5_temp_ram=(Double)obj2.get("ram");
...
int link5_battery_life = 0;
String link5_stemp = null;
double link5_battery_temp = 0l;
while(cursor5.hasNext()){
	DBObject obj1 = cursor5.next();
	link5_total += (Integer)obj1.get("duration");
	link5_battery_life += (Integer)obj1.get("battery_life");
