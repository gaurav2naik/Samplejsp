...
<script src="../script/highmaps.js"></script> 
 --><title>SevenDay</title>
<script type="text/javascript">

//--------------Avg Response chart----------------------------------------
$(function () {
	<%GetChartData responceCh = new GetChartData();
			String appResponceData = responceCh.getAppDataForResponce(7);
			String webResponseData  = responceCh.getWebResposeData(7);
			%>
	$('#container4').highcharts(
			{
				...
				xAxis : {
					...
					categories : [<%out.print(GetChartData.ctData);%> 
],
					labels : {
						rotation : -45,
					/* style: {
...
$(function () {
	<%GetChartData crashChartData = new GetChartData();
			String appCrashData = crashChartData.getDataForCrash(7);
			String webCrashData = crashChartData.getWebCrashData(7);
			%>
...
$(function(){
	<%GetChartData ch = new GetChartData();
			String appHitsData = ch.getDataForHits(7);
			String webHitsData = ch.getWebHitsData(7);
			%>
	$(function () {
	    $('#container3').highcharts({
	        ...
	        title: {
	            text: 'Number Of Hits Per Day (1 Week)',
	            style: {
	                fontSize: '14px',
	                /* fontWeight : 'bold', */
	                fontFamily: 'Verdana, sans-serif'
            ...
            series: [
             	...
             	data: [
                        ...
                        <%try{
                             	...
                             	String data = resp.countryTopFivaMaxAvgResponse(7);
...
<body>
	<div style="width: 99%; color: red;">
		...
		<br>
		 <div id="container3"
			style="width: 45%; margin-right : 2.5%; height: 250px; margin-left : 2.5%; float: left; align: left">
		</div>
		<div id="container4"
 ...
 -->
		 <div id="container1"
			style="align: left;width: 45%; margin-right : 2.5%;  height: 260px; margin-left : 2.5%; float: left; padding-top: 0px;"></div> 
		 <div id="container5"
