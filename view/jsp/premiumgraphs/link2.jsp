...
DBCollection link2_colls = link2_dbs.getCollection("Regular");
...
for(int i = link2_list.size()-1;i >= 0 ; i--)
{
	...
	link2_temp_ram=(Long)obj2.get("ram");
...
long link2_total = 0l;
long link2_cpu_temp = 0l;
long link2_battery_life = 0l;
String link2_stemp = null;
long link2_battery_temp = 0l;
/* int i=1; */
while(cursor2.hasNext()){
	//System.out.print(i++);
	DBObject obj1 = cursor2.next();
	link2_total += (Long)obj1.get("duration");
	link2_cpu_temp += (Long)obj1.get("cpu_temp");
	link2_battery_life += (Long)obj1.get("battery_life");
	link2_stemp = obj1.get("battery_temp").toString();
	//System.out.println(link2_stemp);
	link2_battery_temp += Double.parseDouble(link2_stemp);
}
...
long average_cputemp = (link2_cpu_temp/cursor2.size());
double average_batterytemp = (link2_battery_temp/cursor2.size());
